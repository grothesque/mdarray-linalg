...
fn tensordot_all_axes_impl(backend: &impl MatMul<f64>) {
...
fn tensordot_contract_k_2_should_match_all_axes_impl(backend: &impl MatMul<f64>) {
...
fn tensordot_specific_axes_matrix_multiplication_impl(backend: &impl MatMul<f64>) {
...
fn tensordot_specific_empty_axes_should_outer_product_impl(backend: &impl MatMul<f64>) {
...
fn tensordot_scalar_inputs_should_multiply_impl(backend: &impl MatMul<f64>) {
...
fn tensordot_increase_deep_impl(backend: &impl MatMul<f64>) {
...
fn tensordot_vector_dot_product_impl(backend: &impl MatMul<f64>) {
...
fn tensordot_outer_should_match_manual_kronecker_impl(backend: &impl MatMul<f64>) {
